...
// Convert string to Uint8Array (with ArrayBuffer type for crypto API compatibility)
...
// Generate random bytes (with ArrayBuffer type for crypto API compatibility)
